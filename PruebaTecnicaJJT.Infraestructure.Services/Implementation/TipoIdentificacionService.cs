...
{
    public sealed class TipoIdentificacionService : BaseService, ITipoIdentificacionService
    {
        #region Fields
        ...
        #region Ctor
        public TipoIdentificacionService(IDALGeneric dALGeneric, IMapper mapper)
